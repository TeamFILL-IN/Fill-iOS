//
//  ReportFilmViewController.swift
//  Fillin-iOS
//
...
// MARK: - Extension
extension ReportFilmViewController {
  func layout() {
    layoutNavigaionBar()
    layoutTitleLabel()
  ...
  func layoutReportTextView() {
    self.view.add(reportTextView) {
      ...
      $0.font = .body2
      $0.text = "서비스를 사용하면서 생긴 문의/건의 내용을 입력해\n주세요. 필린님의 소중한 의견이 필린을 성장하게 합\n니다."
      $0.textColor = .grey2
      $0.snp.makeConstraints { make in
...
extension ReportFilmViewController: UITextViewDelegate {
  ...
  func textViewDidEndEditing(_ textView: UITextView) {
    if textView.text.isEmpty {
      textView.text = "서비스를 사용하면서 생긴 문의/건의 내용을 입력해\n주세요. 필린님의 소중한 의견이 필린을 성장하게 합\n니다."
